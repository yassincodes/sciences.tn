import {
  ...
  function Gsix() {
    ...
    const array = [
      {
        title: "الدم",
        color: "#E2E2E2", // light yellow
        fileLink:
          "https://docs.google.com/presentation/d/17wlfAhLP9vXrHYDu_jySbIQtOGRMOeK0/edit?usp=sharing&ouid=112693124397550953816&rtpof=true&sd=true",
        firstGameLink: "",
        secondGameLink: "",
      },
      {
        ...
        color: "#D5E5F5", // gold
        fileLink:
          "https://drive.google.com/file/d/1ECB5NyWqYyeSbD0ai8vTligO5e2eexpa/view?usp=sharing",
        firstGameLink: "",
        secondGameLink: "",
      },
      {
        title: "التغذية",
        color: "#FFC0CB", // light salmon
        fileLink:
          "https://docs.google.com/presentation/d/17wlfAhLP9vXrHYDu_jySbIQtOGRMOeK0/edit?usp=drive_link",
        firstGameLink: "",
        secondGameLink: "",
      },
    ];
