...
// https://codepen.io/rahulsahofficial/pen/vYXwQWQ
...
function Testimonials() {
  return (
    <>
      <div>
        <h2 className="website-testimonials-header">
          تلامذنا يجبون العمل الذي نقوم به
        </h2>{" "}
        <div className="container">
          <div className="div1 eachdiv">
            <div className="userdetails">
              ...
              <div className="detbox">
                <p className="name">أحمد </p>
                <p className="designation">سنة خامسة </p>
              </div>
            </div>
          ...
          <div className="div3 eachdiv">
            <div className="userdetails">
              ...
              <div className="detbox">
                <p className="name dark"> آية</p>
                <p className="designation dark"> سنة سادسة</p>
              </div>
            </div>
          ...
          <div className="div4 eachdiv">
            <div className="userdetails">
              ...
              <div className="detbox">
                <p className="name dark">هاجر </p>
                <p className="designation dark"> </p>
              </div>
            </div>
            <div className="review dark">
          ...
          <div className="div5 eachdiv">
            <div className="userdetails">
              ...
              <div className="detbox">
                <p className="name">ياسين </p>
                <p className="designation"> سنة سادسة</p>
              </div>
            </div>
            <div className="review">
              <h4>
